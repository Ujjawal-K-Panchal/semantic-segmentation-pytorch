"""
Sample code given from root's README.md
"""
...
#note the following paths are under example dir, so it has been added.
train_images = r'example/dataset/cityspaces/images/train'
test_images = r'example/dataset/cityspaces/images/test'
train_labled = r'example/dataset/cityspaces/labeled/train'
test_labeled = r'example/dataset/cityspaces/labeled/test'

predict_input = 'example/dataset/cityspaces/prediction/test_lindau_000003_000019.png'
predict_output = 'example/dataset/cityspaces/prediction/output.png'
if __name__ == '__main__':
    ...
    predict(model, predict_input, predict_output)
